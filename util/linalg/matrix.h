...
ALWAYS_INLINE static inline Mat2x2 mat2x2_identity(void) {

    // this does not care about row-major / column-major ordering
    return (Mat2x2) { .row = _mm_set_ps(1.0F, 0.0F, 0.0F, 1.0F) };
}

ALWAYS_INLINE static inline Mat2x2 mat2x2_zeroed(void) {

    // this does not care about row-major / column-major ordering
    return (Mat2x2) { .row = _mm_set1_ps(0.0F) };
}

ALWAYS_INLINE static inline f32 mat2x2_det(const Mat2x2 *__restrict__ mat) {
    return (mat->val[0] * mat->val[3]) - (mat->val[1] * mat->val[2]);
}

ALWAYS_INLINE static inline Mat4x4 mat4x4_identity(void) {
#if defined(__AVX512F__)
    Mat4x4 mat;
...
ALWAYS_INLINE static inline Mat4x4 mat4x4_zeroed(void) {
#if defined(__AVX512F__)
    Mat4x4 mat;
...
ALWAYS_INLINE static inline f32 mat4x4_det(const Mat4x4 *__restrict__ mat) {

    /* TODO */
    return -1.0F;
}

ALWAYS_INLINE static inline void mat2x2_muls(
        const Mat2x2 *__restrict__ src, Mat2x2 *__restrict__ dst, f32 s) {
    ROW_128(dst, 0) = _mm_mul_ps(ROW_128(src, 0), _mm_set1_ps(s));
}

ALWAYS_INLINE static inline vec2f mat2x2_mulv(const Mat2x2 *__restrict__ src, vec2f v) {
...
ALWAYS_INLINE static inline void mat2x2_mulm(
...
ALWAYS_INLINE static inline void mat2x2_transpose(
...
ALWAYS_INLINE static inline void mat2x2_adjmul(
        const Mat2x2 *__restrict__ a, const Mat2x2 *__restrict__ b, Mat2x2 *__restrict__ c) {
...
ALWAYS_INLINE static inline void mat2x2_muladj(
        const Mat2x2 *__restrict__ a, const Mat2x2 *__restrict__ b, Mat2x2 *__restrict__ c) {
...
ALWAYS_INLINE static inline void mat4x4_muls(
...
ALWAYS_INLINE static inline void mat4x4_transpose(
...
#if defined(__AVX2__)
ALWAYS_INLINE static inline __m256 mat4x4_mulv2(const Mat4x4 *__restrict__ mat, __m256 pv) {
...
#if defined(__AVX512F__)
ALWAYS_INLINE static inline __m512 mat4x4_mulv4(const Mat4x4 *__restrict__ mat, __m512 pv) {
...
ALWAYS_INLINE static inline void mat4x4_mulm(
...
ALWAYS_INLINE static inline Mat4x4 mat4x4_from_rvec(const vec3f v[4]) {
...
ALWAYS_INLINE static inline Mat4x4 mat4x4_from_cvec(const vec3f v[4]) {
...
ALWAYS_INLINE static inline Mat2x2 mat4x4_to_mat2x2(const Mat4x4 *__restrict__ src) {
...
ALWAYS_INLINE static inline Mat4x4 mat2x2_to_mat4x4(const Mat2x2 *__restrict__ src) {
